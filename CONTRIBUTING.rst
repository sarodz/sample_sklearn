...
Welcome to ``sample_sklearn`` contributor's guide.
...
If you experience bugs or general issues with ``sample_sklearn``, please have a look
...
You can help improve ``sample_sklearn`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``sample_sklearn`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``sample_sklearn``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n sample_sklearn python=3 six virtualenv pytest pytest-cov
    conda activate sample_sklearn
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/sample_sklearn.git
    cd sample_sklearn
...
#. Install |pre-commit|_::
   ...
   ``sample_sklearn`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/sample_sklearn
.. _issue tracker: https://github.com/<USERNAME>/sample_sklearn/issues
.. <-- end -->
